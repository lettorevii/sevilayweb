...
const HeroSection = () => {
  return (
    <section className="relative bg-gradient-to-r from-white to-[#EEE5E0] px-6 sm:px-12 md:px-16 lg:px-24 py-8 md:py-12 flex flex-col lg:flex-row items-center justify-between overflow-hidden gap-8 lg:gap-0">
      {/* Sol Taraf - Metin ve Buton */}
      <div className="flex flex-col gap-6 md:gap-8 lg:ml-24 max-w-xl z-10 w-full lg:w-auto">
        <h1 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-poppins text-[#540814] leading-tight">
      ...
      <div className="relative w-full sm:w-80 md:w-96 lg:w-[400px] lg:mr-52 z-10 hidden lg:block">
        <img 
          src="/insan.png" 
