    ...
    <footer className="bg-[#EEE5E0] px-4 md:px-6 lg:px-8 py-8 md:py-12 lg:py-16">
      <div className="mx-auto max-w-[1140px]">
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 md:gap-8 lg:gap-12">
          ...
          {/* Orta Sütun - Menü */}
          <div>
            <h3 style={{ fontSize: 'clamp(18px, 5vw, 18pt)' }} className="font-poppins font-bold text-[#540814] mb-4 md:mb-6">
              Menü
            </h3>
          ...
          <div className="sm:col-span-2 lg:col-span-1">
            ...
            <div className="space-y-3 md:space-y-4">
              ...
              <div className="flex items-start gap-2 md:gap-3">
                ...
                <a href="tel:05322298477" style={{ fontSize: 'clamp(12px, 3vw, 14pt)' }} className="font-poppins text-[#540814] hover:opacity-70 transition-opacity break-all">
                  0532 229 84 77
                </a>
              </div>
              ...
              <div className="flex items-start gap-2 md:gap-3">
                ...
                <a href="mailto:info@drsevilayabudaram.com" style={{ fontSize: 'clamp(12px, 3vw, 14pt)' }} className="font-poppins text-[#540814] hover:opacity-70 transition-opacity break-all">
              ...
              <div className="flex items-start gap-2 md:gap-3">
                ...
                <p style={{ fontSize: 'clamp(12px, 3vw, 14pt)' }} className="font-poppins text-[#540814]">
              ...
              <div className="flex gap-2 md:gap-3 pt-3 md:pt-4">
                {/* LinkedIn */}
                <a href="https://linkedin.com" target="_blank" rel="noopener noreferrer" className="w-8 md:w-10 h-8 md:h-10 bg-[#540814] rounded flex items-center justify-center hover:opacity-80 transition-opacity">
                  <Linkedin className="w-4 md:w-5 h-4 md:h-5 text-white" />
                </a>

                {/* Facebook */}
                <a href="https://facebook.com" target="_blank" rel="noopener noreferrer" className="w-8 md:w-10 h-8 md:h-10 bg-[#540814] rounded flex items-center justify-center hover:opacity-80 transition-opacity">
                ...
                {/* Instagram */}
                <a href="https://instagram.com" target="_blank" rel="noopener noreferrer" className="w-8 md:w-10 h-8 md:h-10 bg-[#540814] rounded flex items-center justify-center hover:opacity-80 transition-opacity">
                  <svg className="w-4 md:w-5 h-4 md:h-5 text-white" fill="currentColor" viewBox="0 0 24 24">
                ...
                {/* YouTube */}
                <a href="https://youtube.com" target="_blank" rel="noopener noreferrer" className="w-8 md:w-10 h-8 md:h-10 bg-[#540814] rounded flex items-center justify-center hover:opacity-80 transition-opacity">
