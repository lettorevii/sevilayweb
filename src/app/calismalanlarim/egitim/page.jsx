...
const page = () => {
  return (
    <>
      ...
      <div className="w-full flex flex-col md:flex-row justify-center py-8 md:py-12">
        <div className="max-w-[1140px] w-full mx-auto px-8 md:px-0">
          <div className="flex flex-col md:flex-row md:items-start gap-8">

            {/* Content Area */}
            <div className="flex-1">
              <div className="space-y-6 text-[#333333] font-poppins px-4 md:px-0">
            ...
            {/* Sidebar */}
            <div className="md:self-start md:sticky md:top-8 md:order-none order-last">
              <SideBar />
            </div>
