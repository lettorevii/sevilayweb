          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 md:gap-16 items-start">
            ...
            <div>
              ...
              <div className="flex gap-3 md:gap-4 mt-6 md:mt-8">
                <a 
                  href="https://www.linkedin.com/in/dr-sevilay-abudaram-771ab311/" 
                  target="_blank" 
                ...
                <a 
                  href="https://www.facebook.com/people/Dr-Sevilay-Abudaram/100067127251247/" 
                  target="_blank" 
                  rel="noopener noreferrer" 
                  className="w-10 md:w-12 h-10 md:h-12 bg-[#540814] rounded flex items-center justify-center hover:opacity-80 transition-opacity"
                >
                ...
                <a 
                  href="https://www.instagram.com/dr.sevilayabudaram/" 
                  target="_blank" 
                  rel="noopener noreferrer" 
                  className="w-10 md:w-12 h-10 md:h-12 bg-[#540814] rounded flex items-center justify-center hover:opacity-80 transition-opacity"
                >
                ...
                <a 
                  href="https://www.youtube.com/@DrSevilayAbudaram" 
                  target="_blank" 
                  rel="noopener noreferrer" 
                  className="w-10 md:w-12 h-10 md:h-12 bg-[#540814] rounded flex items-center justify-center hover:opacity-80 transition-opacity"
                >
                  <Youtube className="w-5 md:w-6 h-5 md:h-6 text-white" />
                </a>
              </div>
            </div>
